...
const portfolioTexts = {
  ...
  "scss-crm": {
    en: "CRM website simulation (without logic) with SCSS-based styling.",
    ua: "Імітація сайту CRM (без логіки) зі стилізацією SCSS.",
    ru: "Имитация сайта CRM (без логики) со стилизацией SCSS.",
  },
  "car-rental": {
